        ...
        <div class="col-md-6 mt-5 m-auto bg-white shadow font-monospace border border-info">
            ...
            <form action="login1.php" method="POST">
                <div class="mb-3">
                    ...
                    <input type="text" name="name" placeholder="Enter UserName or Email Address" class="form-control">
                </div>
                ...
                <div class="mb-3">
                    <button class="w-100 bg-danger fs-4 fw-bold text-white">LOGIN</button>
                </div>
                <div class="mb-3">
                    <button name="submit"class="w-100 bg-warning fs-4 fw-bold text-white"><a href="register.php" class="text-decoration-none text-white fw-bold">I HAVE NO ACCOUNT</a></button>
                </div>
            </form>
        </div>
    </div>
